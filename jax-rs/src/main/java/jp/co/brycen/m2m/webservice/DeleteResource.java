...
import jp.co.brycen.m2m.process.DeleteProcess;
...
@Path("/m2m")
@Component
public class DeleteResource extends AbstractWebService {

	@POST
	@Path("/delete")
	@Consumes("application/json")
	@Produces("application/json")
	public AbstractResponse delete(DeleteItemRequest item) throws SQLException {
	...
	protected AbstractProcess[] getProcesses() {
		return new AbstractProcess[] { new DeleteProcess(this) };
	}
}